            ...
            <CardContent className="space-y-5">
                ...
                <div className="space-y-1.5">
                    ...
                    <Popover>
                        ...
                        >
                            {data.shippingDate
                            ? format(data.shippingDate, "dd/MM/yyyy")
                            : "DD/MM/YYYY"}
                    ...
                    <div className="grid grid-cols-2 gap-x-8 gap-y-4">
                        ...
                        {route.shippingDate && (
                            <ReviewField
                                ...
                                value={format(route.shippingDate, "dd/MM/yyyy")}
                            />
                        )}
                    </div>
                </div>  
...
function SuccessModal({ open, onClose }: Readonly<{ open: boolean; onClose: () => void }>) {
    return (
        <Dialog open={open} onOpenChange={(isOpen) => { if (!isOpen) onClose() }}>
            <DialogContent className="sm:max-w-lg rounded-2xl px-8 py-10 text-center">
                ...
                <p className="text-sm text-gray-500 leading-relaxed mb-8">
                    ...
                    send you a detailed quote within 15-30 minutes.
                </p>

                {/* Actions */}
                <div className="grid grid-cols-2 gap-3">
                    <Link href="/user/shipments">
                        <Button variant="outline" className="border-[#2563EB] text-[#2563EB] hover:bg-blue-50"onClick={onClose}>
                            View my Shipments
                        </Button>
                    </Link>
                    <Link href="/user/dashboard ">
                        <Button className="bg-[#2563EB] hover:bg-[#2563EB]/80 text-white" onClick={onClose}>
                            Go to Dashboard
                        </Button>
                    </Link>
                </div>
...
export default function RequestQuotePage() {
    ...
    return (
        <div className="space-y-6 lg:space-y-8">
            ...
            {/* Success Modal */}
            {submitted && <SuccessModal open={submitted} onClose={() => setSubmitted(false)} />}
